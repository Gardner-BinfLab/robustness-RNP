...
grep "Name=$1;" AL157959-ncRNAs-nonredundant.gff | sort -k6nr | head -n 1 | perl -lane '($F[3],$F[4])=($F[4],$F[3]) if ($F[6] eq "-");  print "sfetch -d AL157959.fasta -r \42AL157959/$F[3]-$F[4]\42 -f $F[3] -t $F[4] \42AL157959;\42"' | sh >> ncrna-seqs/$1.fasta
